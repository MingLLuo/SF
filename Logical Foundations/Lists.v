...
Theorem add_inc_count : forall (l: natlist) (v : nat),
...
Proof.
  ...
  induction l.
  - reflexivity.
  - simpl. rewrite identity. rewrite IHl. reflexivity.
Qed.
(* ================================================================= *)
...
Proof.
  ...
  - reflexivity.
  - simpl. induction n.
    + rewrite identity. rewrite leb_n_Sn.
      reflexivity.
