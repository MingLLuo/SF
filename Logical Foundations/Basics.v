...
Proof.
  ...
  - reflexivity.
  - reflexivity.
  - rewrite -> lower_letter_F_is_F. intros H. inversion H.
Qed. 
...
Proof.
  intros late_days g H H0. rewrite apply_late_policy_unfold. rewrite H, H0. reflexivity.
Qed.
End LateDays.
