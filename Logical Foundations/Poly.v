...
Fixpoint split {X Y : Type} (l : list (X*Y)) : (list X) * (list Y) :=
  match l with
  | nil => (nil, nil)
  | (x1, y1) :: t => let (x2, y2) := split t in (x1 :: x2, y1 :: y2)
  end.
...
Proof. unfold partition. reflexivity. Qed.
...
(** **** Exercise: 1 star, standard, optional (fold_types_different)
    ...
    different? *)
(* Calculate the size of 2D-array, [|n1|; |n2|; ....] *)
